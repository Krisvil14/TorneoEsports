...
Revision ID: 88533b5471c2
Revises: 
Create Date: 2025-06-20 00:47:55.396426
...
def upgrade():
    ...
    sa.Column('team1_stats_data', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    sa.Column('team2_stats_data', postgresql.JSON(astext_type=sa.Text()), nullable=True),
